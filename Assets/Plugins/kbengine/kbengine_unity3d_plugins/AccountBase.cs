...
namespace KBEngine
{
	...
	public abstract class AccountBase : Entity
	{
		...
		public abstract void onEnterGameFailed(SByte arg1); 
		public abstract void onEnterGameSuccess(); 
		public abstract void onFirstEntityHello(string arg1); 
		...
		public override void onRemoteMethodCall(MemoryStream stream)
		{
			...
			{
				case 3:
					SByte onEnterGameFailed_arg1 = stream.readInt8();
					onEnterGameFailed(onEnterGameFailed_arg1);
					break;
				case 4:
					onEnterGameSuccess();
					break;
				case 5:
					string onFirstEntityHello_arg1 = stream.readUnicode();
					onFirstEntityHello(onFirstEntityHello_arg1);
					break;
				default:
					break;
			};
